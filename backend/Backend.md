...
parctica fundamental:Una vez que lo tengas todo coinectado vete a /backend/seeds y dale al comando 'node UserAdmin.js',esto va inicializar el usuario administrador de la BD
